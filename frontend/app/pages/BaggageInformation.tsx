        ...
        >
          ...
          <View style={{ paddingHorizontal: 20 }}>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity style={styles.option} onPress={() => setCheckedBag(true)}>
                <View style={styles.optionLeft}>
                  <Briefcase color="#6B7280" size={22} />
                  <View style={styles.optionText}>
                    <Text style={styles.optionTitle}>1 checked bag (Max 22.1 lbs)</Text>
              ...
              <TouchableOpacity style={styles.option} onPress={() => setCheckedBag(false)}>
                <View style={styles.optionLeft}>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity style={styles.option} onPress={() => setInsurance(true)}>
                <View style={styles.optionLeft}>
              ...
              {insurance && (
                <View style={styles.protectionDetails}>
                  {[
                    ...
                    'Magna eu mollit veniam ipsum dolore anim',
                    'Velit cillum minim ullamco excepteur dolore sint',
                    'Ullamco incididunt fugiat tempor anim excepteur',
                  ].map((text, index) => (
              ...
              <TouchableOpacity style={styles.option} onPress={() => setInsurance(false)}>
                <View style={styles.optionLeft}>
                  <View style={styles.noBagIcon}>
                    <Text style={styles.noBagText}>✕</Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  protectionDetails: { marginLeft: 36, marginTop: 8, marginBottom: 10 },
  protectionItem: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 },
  checkmark: { color: '#10B981', marginRight: 8, fontSize: 16 },
  protectionText: { flex: 1, fontSize: 13, color: '#6B7280', lineHeight: 20 },
  footer: {
    borderTopWidth: 1,
